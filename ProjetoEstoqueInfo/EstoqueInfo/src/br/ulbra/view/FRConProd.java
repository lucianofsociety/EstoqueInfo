 ...
 */
public class FRConProd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Nome", "Codigo", "Quantidade", "Consulta"
            }
        ));
    ...
    private void pesquisar() {
        ...
        for (Produto prod : controller.readForDesc(txtFiltro.getText())) {
            Object[] linha = {prod.getPkProduto(), prod.getNomeProd(), prod.getCodProd(),
                prod.getQuantProd(), prod.getEstoquProd()};
            modelo.addRow(linha);
    ...
    private void TabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaMouseClicked
       ...
       FRUPDProd telaUPD = new FRUPDProd();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRConProd.class
